    ...
    public static ApiService getCloud() {
        if (retrofit == null) {
            retrofit = new Retrofit.Builder()
                    .baseUrl(AppConfig.INSTANCE.getHOT_URL())//设置Base的访问路径
   ...
   public static class QueryParameterInterceptor implements Interceptor {
        ...
        public Response intercept(Chain chain) throws IOException {
            ...
            HttpUrl modifiedUrl = originalRequest.url().newBuilder()
                    ...
                    .addQueryParameter("ver", AppConfig.INSTANCE.getVER())
                    .build();
    ...
    public static class CacheControlInterceptor implements Interceptor {
        ...
        public Response intercept(Chain chain) throws IOException {
            ...
            // 无网络时加载缓存
            if (!NetUtil.INSTANCE.isNetworkAvailable(CloudApplication.Companion.instance())) {
    ...
    private static Cache getCache() {
        File file = new File(CloudApplication.Companion.instance().getCacheDir(), "GlobalCache");
